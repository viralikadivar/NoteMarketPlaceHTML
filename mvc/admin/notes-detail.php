                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <div class="dropdown user-image">
                                    <img id="image-menu" data-toggle="dropdown" src="../images/header-footer/user-img.png" alt="Admin">
                    ...
                    <div class="col-lg-7 col-md-12 col-sm-12">
                        ...
                        <div class="row  book-info">
                            ...
                            <div class="col-lg-8  col-md-8 col-sm-8 heading">
                                ...
                                <button type="submit" data-toggle="modal" data-target="#exampleModalScrollable"><a href="#">download/&#36;15</a></button>
                            </div>
                        </div>
                    </div>
