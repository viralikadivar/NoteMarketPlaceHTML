                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 pl-0">
                                    <input type="text" name="phoneNumber" class="form-control" id="phone-number" value="<?php if ($isSet) {
                                                                                                                            echo $phoneNumber;
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="addrLine1" class="form-control" id="add-1" value="<?php if ($isSet) {
                                                                                                            echo $add1;
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="addrLine2" class="form-control" id="add-2" value="<?php if ($isSet) {
                                                                                                            echo $add2;
                                                                                                        } ?>" placeholder="Enter Your address">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="city" class="form-control" id="city" value="<?php if ($isSet) {
                                                                                                        echo $city;
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="state" class="form-control" id="state" value="<?php if ($isSet) {
                                                                                                        echo $state;
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="zipCode" class="form-control" id="zipcode" value="<?php if ($isSet) {
                                                                                                            echo $zipCode;
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="country" class="form-control" id="country" value="<?php if ($isSet) {
                                                                                                            echo $country;
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="university" class="form-control" id="university" value="<?php if ($isSet) {
                                                                                                                    echo $university;
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="college" class="form-control" id="college" value="<?php if ($isSet) {
                                                                                                            echo $college;
