...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2021 at 01:11 PM
...
CREATE TABLE `notesdetails` (
  ...
  `ModifiedBy` int(11) DEFAULT NULL,
  `IsActive` bit(1) NOT NULL DEFAULT b'1',
  `Ratings` decimal(10,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(7, 'Submitted', 'Submitted', 'Notes Status', NULL, NULL, '2021-03-25 23:14:11', NULL, b'1'),
...
INSERT INTO `systemconfiguration` (`ID`, `KeyFields`, `Value`, `CreatedDate`, `CreatedBy`, `ModifiedDate`, `ModifiedBy`, `IsActive`) VALUES
(1, 'SupportEmailAddress', 'bannupatel34@gmail.com', '2021-03-01 15:32:36', 1, '2021-03-01 16:44:47', 1, b'1'),
(2, 'SupportContactNumber', '8160724440', '2021-03-01 15:33:25', 1, '2021-03-24 16:29:30', 1, b'1'),
(3, 'EmailAddressesForNotify', 'virakadivar33@gmail.com', '2021-03-01 15:34:30', 1, '2021-03-03 22:39:06', 1, b'1'),
(4, 'DefaultNoteDisplayPicture', '', '2021-03-01 15:36:20', 1, '2021-03-01 15:36:20', 1, b'1'),
(5, 'DefaultMemberDisplayPicture', '', '2021-03-01 15:36:53', 1, '2021-03-01 15:36:53', 1, b'1'),
(6, 'FBIcon', '', '2021-03-01 15:37:56', 1, '2021-03-01 15:42:00', 1, b'1'),
(7, 'TwitterIcon', '', '2021-03-01 15:38:27', 1, '2021-03-01 15:42:16', 1, b'1'),
(8, 'LinkedInIcon', '', '2021-03-01 15:39:11', 1, '2021-03-01 15:39:11', 1, b'1');
...
(1, 'Super Admin', 'Super admin will have control on admin , members and other coonfigutration files', '2021-02-24 11:29:01', NULL, '2021-02-24 11:29:27', NULL, b'1'),
(2, 'Admin', 'Admin have control on members and their published notes.', '2021-02-24 11:29:38', NULL, '2021-02-24 11:29:47', NULL, b'1'),
(3, 'Member', 'Members are front end users ,who uploads and downloads notes from website.', '2021-02-24 11:29:54', NULL, '2021-02-24 11:29:59', NULL, b'1');
...
--
ALTER TABLE `reportedissues`
  ADD CONSTRAINT `AgainstDownloadID` FOREIGN KEY (`AgainstDownloadID`) REFERENCES `users` (`ID`),
  ADD CONSTRAINT `NoteID` FOREIGN KEY (`NoteID`) REFERENCES `notesdetails` (`ID`),
